...
const SelectAllCell: React.FC<SelectAllTableCellProps> = ({ theme = "light", selectAll, toggleSelectAll, size = "small", sx = {} }) => {
    ...
    const tableCellStyles = {
        ...
        borderBottom: isLightTheme ? "none" : "1px solid #686868",
        ...sx,
    };
