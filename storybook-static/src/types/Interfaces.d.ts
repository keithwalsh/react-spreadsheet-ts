import { CSSProperties, DragEventHandler } from '../../node_modules/react';
import { MenuItemProps, PopoverOrigin, SxProps, TextFieldProps, Theme } from '@mui/material';
import { PrimitiveAtom } from 'jotai';
import { ArrowBack, ArrowDownward, ArrowForward, ArrowUpward } from '@mui/icons-material';
import { ColumnContextMenu, RowContextMenu } from '../components';
import { ActionConfig, Alignment, ButtonType, ColumnContextMenuProps, DimensionType, DirectionalMenuProps, InsertPosition, Orientation, SelectionType, SpreadsheetDirection, TableSizeChooserProps, ToolbarActionHandlers, TooltipPlacement } from './';
...
export interface ToolbarContextType extends BaseContextType, Omit<ToolbarActionHandlers, 'handleLink'>, UIState, Omit<TableDimensions, 'rows' | 'cols'> {
    currentRows: number;
    currentCols: number;
    setTableSize: (dimensions: Dimensions) => void;
    handleUndo: () => void;
